...
using Wimi.BtlCore.Authorization.Users.Profile.Cache;
using Wimi.BtlCore.Authorization.Users.Profile.Dto;
using Wimi.BtlCore.Friendships;
using Wimi.BtlCore.Identity;
using Wimi.BtlCore.Security;
using Wimi.BtlCore.Storage;
using Wimi.BtlCore.Timing;

namespace Wimi.BtlCore.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : BtlCoreAppServiceBase, IProfileAppService
    {
        private const int MaxProfilPictureBytes = 1048576; //1MB
        private readonly IBtlFolders _appFolders;
