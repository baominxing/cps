...
namespace Wimi.BtlCore.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        private readonly TenantDemoDataManager _demoDataBuilder;
        ...
        public TenantManager(
            ...
            TenantDemoDataManager demoDataBuilder,
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(BtlCoreConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
