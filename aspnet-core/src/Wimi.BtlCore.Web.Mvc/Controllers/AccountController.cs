...
using Wimi.BtlCore.Web.Models.Account;
using Wimi.BtlCore.Web.Views.Shared.Components.TenantChange;
using Wimi.BtlCore.Authorization.Accounts;
using Abp.Localization;

namespace Wimi.BtlCore.Web.Controllers
{
    public class AccountController : BtlCoreControllerBase
    {
        ...
        public ActionResult Login(string userNameOrEmailAddress = "", string returnUrl = "", string successMessage = "")
        {
            ...
            var allLanguages = this.languageManager.GetLanguages();
            var currentLanguage = this.languageManager.CurrentLanguage;
            ...
            return View(new LoginFormViewModel
            {
                ...
                LanguageViewModel = new LanguagesViewModel { AllLanguages = allLanguages, CurrentLanguage = currentLanguage }
            });
        }
