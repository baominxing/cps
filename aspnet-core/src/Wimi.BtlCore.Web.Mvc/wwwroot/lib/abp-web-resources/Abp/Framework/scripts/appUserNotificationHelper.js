...
(function($) {
    ...
    app.UserNotificationHelper = (function() {
        ...
        return function() {
            ...
            /* Example:
            abp.notifications.messageFormatters['Wimi.BtlCore.MyNotificationDataType'] = function(userNotification) {
            ...
            */
            ...
            function getUrl(userNotification) {
                ...
                case "App.NewTenantRegistered":
                    return "/tenants?filterText=" + userNotification.notification.data.properties.tenancyName;
            ...
            var setAllAsRead = function(callback) {
                notificationService.setAllNotificationsAsRead().done(function() {
            ...
            var openSettingsModal = function() {
                new app.ModalManager({
                    viewUrl: abp.appPath + "Notifications/SettingsModal",
                    scriptUrl: abp.appPath + "view-resources/Views/Notification/Notifications/_SettingsModal.js",
